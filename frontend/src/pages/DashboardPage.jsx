                  ...
                  {visibleProjects.length === 0 ? (
                    <div className="flex h-full min-h-[280px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-5 py-10 text-center">
                      ...
                      <p className="mt-2 max-w-md text-sm text-slate-500">
                        Create your first project to start tracking tasks, deadlines, and team activity.
                      </p>
            ...
            <section className="grid gap-6 xl:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
              ...
              <section className="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm">
                ...
                <ActivityList
                  ...
                  emptyDescription="Create or update work in your projects and it will appear here."
                />
              </section>
            </section>
